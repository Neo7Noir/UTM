...
print("metoda bisectoarelor si numarul de iteratii: ", bisect(f2, -1, 1))

print("metoda aproximatiilor succesive si numarul de iteratii: ", aprox(f2fi, -2))
print("metoda newton si numarul de iteratii: ", newton(f2, f2d, f2dd, -1, 1))
print("metoda secantelor si numarul de iteratii: ", secant(f2, -1, 1))